...
<body>
  ...
  <div class="container">
    <div class="row row-st product-container">
      ...
      <?php if (isset($_SESSION['email'])) { ?>
        <a href="#" class="btn btn-dark buy-btn" data-bs-toggle="modal" data-bs-target="#scooter-detail-modal">Buy Now</a>
      <?php } else { ?>
  ...
  <div class="modal fade" id="scooter-detail-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered justify-content-center">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h3 class="text-center modal-buy-subheading">Scooter Details</h3>
          <p class="modal-buy-detail">Scooter Name: <?php echo $product['scooter_name']; ?></p>
          <p class="modal-buy-detail">Scooter Price: <?php echo $product['scooter_price']; ?></p>
          <p class="modal-buy-detail">Scooter Engine: <?php echo $product['scooter_engine']; ?></p>
          ...
          <p class="modal-buy-detail">Scooter Mileage: <?php echo $product['mileage']; ?></p>
          ...
          <a href="#" class="confirm-buy-link scooter-buy-link text-center">Confirm Buy</a>
  ...
  <script>
    $(".scooter-buy-link").click(function(e) {
      e.preventDefault();
      $.ajax({
        type: "GET",
        url: "insert_scooter_sale.php",
        data: {
          scooter_id: <?php echo $_GET['id'] ?>
        },
        dataType: "JSON",
